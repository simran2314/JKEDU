...
<div class="w3-content" style="max-width:1500px">
	...
	<div class="w3-opacity">
		...
		<header class="w3-center w3-margin-bottom">
			...
			<a onclick="get_schools()" class="w3-bar-item w3-button w3-blue">Schools</a>
			<a onclick="get_colleges()" class="w3-bar-item w3-button w3-red">Colleges</a>
			<a onclick="get_universities()" class="w3-bar-item w3-button w3-green">Universities</a>
			<a onclick="get_kvs()" class="w3-bar-item w3-button w3-hide-small w3-yellow">Kendriya <br />Vidyalaya</a>
		</header>
	</div>
...
<!-- Facebook Content 
<div class="fb-page mr-0 mb-4" data-href="https://www.facebook.com/jkedu.in/" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/jkedu.in/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/jkedu.in/">JKEDU</a></blockquote></div>
-->

</div>
<?php if($_SESSION["usercat"]=="admin"){ ?>
	<center>  
